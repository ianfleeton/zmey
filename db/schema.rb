...
ActiveRecord::Schema.define(:version => 20111130111142) do
  ...
  add_index "shipping_table_rows", ["shipping_class_id"], :name => "index_shipping_table_rows_on_shipping_class_id"
