    ...
    describe 'GET index' do
      ...
      context 'with user supplied' do
        it 'assigns all orders for the supplied user to @orders' do
          ...
          Order.create!(user_id: u.id, email_address: 'user@example.org', delivery_address_line_1: 'a', delivery_town_city: 'tc', delivery_postcode: 'pc', delivery_country: country, website_id: website.id)
          Order.create!(user_id: u.id, email_address: 'user@example.org', delivery_address_line_1: 'a', delivery_town_city: 'tc', delivery_postcode: 'pc', delivery_country: country, website_id: website.id)
